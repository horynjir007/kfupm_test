...
'
  'LivoxToPcl' 'waitForRos; roslaunch livox_ros_driver2 pcl_livox_to_ros.launch
'
  'Camera' 'waitForRos; roslaunch depthai_ros_driver rgbd_pcl.launch
'
  'Bumper' 'waitForRos; roslaunch ./launch/bumper.launch custom_config:=./config/custom_config.yaml
'
